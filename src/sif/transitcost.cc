...
void ParseTransitCostOptions(const rapidjson::Document& doc,
  ...
  if (json_costing_options) {
    ...
    if (filter_stop_action_str &&
        odin::FilterAction_Parse2(*filter_stop_action_str, &filter_stop_action)) {
    ...
    if (filter_operator_action_str &&
        odin::FilterAction_Parse2(*filter_operator_action_str, &filter_operator_action)) {
    ...
    if (filter_route_action_str &&
        odin::FilterAction_Parse2(*filter_route_action_str, &filter_route_action)) {
