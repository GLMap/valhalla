...
public:
   ...
   */
  std::span<const GraphId> GetBin(size_t column, size_t row) const;
   ...
   * @return iterable container of graphids contained in the bin
   */
  std::span<const GraphId> GetBin(size_t index) const;
   ...
   */
  std::span<const DiscretizedBoundingCircle> GetBoundingCircles(size_t column, size_t row) const;
   ...
   * @return iterable container of bounding circles that intersect the bin
   */
  std::span<const DiscretizedBoundingCircle> GetBoundingCircles(size_t index) const;
...
protected:
  ...
  const DiscretizedBoundingCircle* bounding_circles_{};
